package com.utfinancing.financehub.etl.commveh.controller;

import com.baomidou.mybatisplus.core.toolkit.StringUtils;
import com.utfinancing.financehub.common.core.dto.R;
import com.utfinancing.financehub.etl.commveh.model.QueryRepaymentPlanDTO;
...
@Slf4j
@RestController
@RequestMapping("/commveh")
public class CommvehDataController {
    ...
    public R<List<RepaymentPlanSaveDTO>> queryRepaymentPlan(@RequestBody @Valid QueryRepaymentPlanDTO params) {
        return R.ok(commercialVehicleDataService.getRepaymentPlanFromSYCXT(params));
    }
    ...
    public R<List<SelectReceiveRepaymentDTO>> queryReceivedRepaymentPlan(@RequestBody @Valid QueryRepaymentPlanDTO params) {
        ...
        return R.ok(commercialVehicleDataService.selectReceiveRepayment(dto));
    }
}
