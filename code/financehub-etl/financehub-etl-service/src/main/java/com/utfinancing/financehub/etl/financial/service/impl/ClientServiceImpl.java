...
import com.utfinancing.financehub.etl.financial.mapper.ClientMapper;
import com.utfinancing.financehub.etl.financial.service.IClientService;
...
public class ClientServiceImpl extends ServiceImpl<ClientMapper, ClientEntity> implements IClientService {
    ...
    @Override
    public List<ClientEntity> selectAllClient() {
        return this.list(Wrappers.<ClientEntity>lambdaQuery().isNull(ClientEntity::getClientName));
    }
}
