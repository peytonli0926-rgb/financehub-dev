package com.utfinancing.financehub.etl.passvehat.controller;
...
@Slf4j
@RestController
@RequestMapping("/passvehat")
public class PassvehatDataController {
    ...
    public R<List<RepaymentPlanSaveDTO>> queryRepaymentPlan(@RequestBody @Valid QueryRepaymentPlanDTO params) {
        return R.ok(passengerVehicleAssetTransferDataService.getRepaymentPlanFromCYCXT(params));
    }
    ...
    public R<List<SelectReceiveRepaymentDTO>> queryReceivedRepaymentPlan(@RequestBody @Valid QueryRepaymentPlanDTO params) {
        ...
        return R.ok(passengerVehicleAssetTransferDataService.selectReceiveRepayment(dto));
    }
}
