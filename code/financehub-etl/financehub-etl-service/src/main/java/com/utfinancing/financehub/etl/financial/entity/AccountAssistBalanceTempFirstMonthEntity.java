...
@TableName("eg_account_assist_balance_temp_fist_month")
public class AccountAssistBalanceTempFirstMonthEntity extends Model<AccountAssistBalanceTempFirstMonthEntity> {
