...
@TableName("eg_account_assist_balance_temp_close_period")
public class AccountAssistBalanceTempClosePeriodEntity extends Model<AccountAssistBalanceTempClosePeriodEntity> {
