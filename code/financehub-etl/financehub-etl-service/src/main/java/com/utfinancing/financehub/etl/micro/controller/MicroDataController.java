package com.utfinancing.financehub.etl.micro.controller;
...
import com.utfinancing.financehub.etl.micro.model.QueryRepaymentPlanDTO;
...
public class MicroDataController {
    ...
    public R<List<RepaymentPlanSaveDTO>> queryRepaymentPlan(@RequestBody @Valid QueryRepaymentPlanDTO params) {
        return R.ok(microDataService.getRepaymentPlanFromXWXT(params));
    }
    ...
    public R<List<SelectReceiveRepaymentDTO>> queryReceivedRepaymentPlan(@RequestBody @Valid QueryRepaymentPlanDTO params) {
        ...
        return R.ok(microDataService.selectReceiveRepayment(dto));
    }
}
