...
import com.utfinancing.financehub.admin.mapper.SysDictTypeMapper;
...
public class SysDictTypeServiceImpl implements ISysDictTypeService {
    ...
    public List<SysDictData> selectDictDataByType(String dictType, String status) {
        ...
        if (StringUtils.isNotEmpty(dictDatas)) {
            dictDatas = dictDatas.stream().filter(e->StringUtils.equals(e.getStatus(),status)).collect(Collectors.toList());
            return dictDatas;
        }
    ...
    public int updateDictType(Long dictId, SysDictType dict) {
        dict.setDictId(dictId);
        SysDictType oldDict = dictTypeMapper.selectDictTypeById(dictId);
