...
-- Interface configuration contains raw source fields only. These fields are
-- computed by the engine and must not be presented as upstream parameters.
UPDATE financehub_lease.eg_scene_fields
