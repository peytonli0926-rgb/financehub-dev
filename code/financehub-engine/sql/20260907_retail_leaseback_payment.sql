...
VALUES
    ...
    (202609070700009, 'CYC_RETAIL_LEASEBACK', '融资租赁业务-回租-乘用车', 'vehicle_profit_sharing_payable', '220212', '应付账款_应付车辆分润费', '负债', 'retail-payment-config', NOW(), 'retail-payment-config', NOW(), '0', 'CR', '0', '1', '1', 'intra', '0'),
