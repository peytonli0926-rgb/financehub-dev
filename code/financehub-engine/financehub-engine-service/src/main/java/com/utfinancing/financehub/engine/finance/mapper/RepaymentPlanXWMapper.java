...
public interface RepaymentPlanXWMapper extends BaseMapper<RepaymentPlanXWEntity> {
     ...
     * 根据合同分页，取得合同的所有期初数据
     */
    public List<RepaymentPlanXWEntity> selectHyInitDataByPage(GetProcessDataDTO params);
     ...
     * 取得initDate前一条数据
     */
    public List<RepaymentPlanXWEntity> selectMaxDateDateByInitDate(@Param("initDate") String initDate);
