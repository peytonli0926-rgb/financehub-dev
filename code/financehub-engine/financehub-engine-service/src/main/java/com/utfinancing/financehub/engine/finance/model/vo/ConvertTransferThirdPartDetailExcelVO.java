...
@Setter
@ApiModel
public class ConvertTransferThirdPartDetailExcelVO {
    ...
    public static ConvertTransferThirdPartDetailExcelVO from(ConvertTransferThirdPartDetailEntity entity) {
        ConvertTransferThirdPartDetailExcelVO vo = new ConvertTransferThirdPartDetailExcelVO();
