 ...
 * @Description :   FundBusinessSystemEbankAmountMapping查询from对象
 * @Modified :
 */
@ApiModel("FundBusinessSystemEbankAmountMapping查询表单")
@Data
@EqualsAndHashCode(callSuper = true)
public class FundBusinessSystemEbankAmountMappingQueryDTO extends BaseQueryDTO{
