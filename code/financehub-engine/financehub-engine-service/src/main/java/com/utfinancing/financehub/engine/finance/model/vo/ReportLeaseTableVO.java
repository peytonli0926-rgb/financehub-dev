 ...
 */
@Data
public class ReportLeaseTableVO implements Serializable{
    ...
    private BigDecimal receivableRentBalance = BigDecimal.ZERO;

    @ApiModelProperty(value = "应收首付款")
    private BigDecimal receivableDownpaymentBalance = BigDecimal.ZERO;

    @ApiModelProperty(value = "应收期末残值")
    private BigDecimal receivableResidualValueBalance  = BigDecimal.ZERO;

    @ApiModelProperty(value = "应收手续费")
    private BigDecimal receivableCommissionBalance = BigDecimal.ZERO;

    @ApiModelProperty(value = "应收保险费")
    private BigDecimal receivableInsuranceBalance = BigDecimal.ZERO;

    @ApiModelProperty(value = "应收其他收入")
    private BigDecimal receivableOtherincomeBalance = BigDecimal.ZERO;

    @ApiModelProperty(value = "应收返利")
    private BigDecimal receivableRebateBalance = BigDecimal.ZERO;

    @ApiModelProperty(value = "应收销项税")
    private BigDecimal receivableOuttaxBalance = BigDecimal.ZERO;

    @ApiModelProperty(value = "应收销项税-本金")
    private BigDecimal receivableOutputtaxBaseBalance = BigDecimal.ZERO;

    @ApiModelProperty(value = "未实现收益-总")
    private BigDecimal unrealizedRevenueBalance = BigDecimal.ZERO;

    @ApiModelProperty(value = "未实现收益-不含服务费")
    private BigDecimal rentalIncomeAfterTotal = BigDecimal.ZERO;

    @ApiModelProperty(value = "融资租赁收益余额")
    private BigDecimal leaseRevenueBalance = BigDecimal.ZERO;

    @ApiModelProperty(value = "减值准备余额")
    private BigDecimal depreciationReservesBalance = BigDecimal.ZERO;

    @ApiModelProperty(value = "承租人保证金")
    private BigDecimal lesseeMarginBalance = BigDecimal.ZERO;

    @ApiModelProperty(value = "TA重分类")
    private BigDecimal taAmount = BigDecimal.ZERO;

    @ApiModelProperty(value = "逾期收益")
    private BigDecimal overdueEarnings = BigDecimal.ZERO;
