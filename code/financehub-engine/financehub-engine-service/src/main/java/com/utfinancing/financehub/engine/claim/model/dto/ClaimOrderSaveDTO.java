...
/**
 * @Author : lixin
 * @Date : Create in 23/10/2023
 */
@Data
public class ClaimOrderSaveDTO {
    ...
    @ApiModelProperty("报销单据明细列表")
    private List<ClaimOrderDetailSaveDTO> claimDetailList;

    @ApiModelProperty("发票数据集合")
    private List<ClaimOrderInvoiceSaveDTO> invoiceList;

    @ApiModelProperty("专项费用集合")
    private List<ClaimOrderSpecialSaveDTO> specialExpenseList;

    @ApiModelProperty("付款信息集合")
    private List<ClaimOrderPaymentSaveDTO> paymentList;
}
