 ...
 */
@Data
public class ModifyEbankNoConfirmRecordDTO implements Serializable{
...
//    private String systemCode;
    ...
    @ApiModelProperty(value = "原业务系统批扣流水号", required = true)
    ...
    @ApiModelProperty(value = "认领金额", required = true)
...
//    @ApiModelProperty(value = "做账主体编码")
//    private String orgId;
//
//    @ApiModelProperty(value = "做账主体名称")
//    private String orgName;

    @ApiModelProperty(value = "新业务系统批扣流水号", required = true)
