 ...
 * @Description :   CheckAccountKingdeeResultHis查询from对象
 * @Modified :
 */
@ApiModel("CheckAccountKingdeeResultHis查询表单")
@Data
@EqualsAndHashCode(callSuper = true)
public class CheckAccountKingdeeResultHisQueryDTO extends BaseQueryDTO{
