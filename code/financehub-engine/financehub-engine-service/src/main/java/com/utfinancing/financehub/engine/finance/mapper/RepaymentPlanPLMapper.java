...
public interface RepaymentPlanPLMapper extends BaseMapper<RepaymentPlanPLEntity> {
     ...
     * 根据合同分页，取得合同的所有期初数据
     */
    public List<RepaymentPlanPLEntity> selectHyInitDataByPage(GetProcessDataDTO params);
     ...
     * 取得initDate前一条数据
     */
    public List<RepaymentPlanPLEntity> selectMaxDateDateByInitDate(@Param("initDate") String initDate);
