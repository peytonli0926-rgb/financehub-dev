 ...
 * @Description :   FundBusinessSystemEbankMapping查询from对象
 * @Modified :
 */
@ApiModel("FundBusinessSystemEbankMapping查询表单")
@Data
@EqualsAndHashCode(callSuper = true)
public class FundBusinessSystemEbankMappingQueryDTO extends BaseQueryDTO{
