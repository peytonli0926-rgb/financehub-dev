 ...
 */
@Data
public class ContractBalanceVO implements Serializable{
    ...
    @ApiModelProperty("委托贷款应收利息减值准备余额")
    private BigDecimal depreciationReservesEntrustedLoansInterestBalance;

    @ApiModelProperty("委托贷款应收利息减值准备发生额")
    private BigDecimal depreciationReservesEntrustedLoansInterestAmount;
