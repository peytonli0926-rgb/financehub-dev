...
@TableName("eg_fund_business_system_ebank_wy_amount")
public class FundBusinessSystemEbankWyAmountEntity extends Model<FundBusinessSystemEbankWyAmountEntity> {
