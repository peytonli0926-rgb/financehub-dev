 ...
 */
@Mapper
public interface RepaymentPlanYYMapper extends BaseMapper<RepaymentPlanYYEntity> {
     ...
     * 根据合同分页，取得合同的所有期初数据
     */
    public List<RepaymentPlanYYEntity> selectHyInitDataByPage(GetProcessDataDTO params);
     ...
     * 取得initDate前一条数据
     */
    public List<RepaymentPlanYYEntity> selectMaxDateDateByInitDate(@Param("initDate") String initDate);
