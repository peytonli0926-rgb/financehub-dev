...
public class ContractBalanceLatestEntity extends Model<ContractBalanceLatestEntity> {
    ...
    @ApiModelProperty("其它业务成本-经销商服务费发生额")
    @TableField(exist = false)
    private BigDecimal otherBusinessCostAgencyAmount;

    @ApiModelProperty("其它业务成本-经销商服务费余额")
    @TableField(exist = false)
    private BigDecimal otherBusinessCostAgencyBalance;

    @ApiModelProperty("其它业务成本-经销商服务费发生额")
    @TableField(exist = false)
    private BigDecimal otherBusinessCostVehicleAmount;

    @ApiModelProperty("其它业务成本-经销商服务费余额")
    @TableField(exist = false)
    private BigDecimal otherBusinessCostVehicleBalance;

    @ApiModelProperty("其它业务成本-经销商服务费发生额")
    @TableField(exist = false)
    private BigDecimal otherBusinessCostPledgeAmount;

    @ApiModelProperty("其它业务成本-经销商服务费余额")
    @TableField(exist = false)
    private BigDecimal otherBusinessCostPledgeBalance;

    @ApiModelProperty("其它业务成本-经销商服务费发生额")
    @TableField(exist = false)
    private BigDecimal otherBusinessCostUnpledgeAmount;

    @ApiModelProperty("其它业务成本-经销商服务费余额")
    @TableField(exist = false)
    private BigDecimal otherBusinessCostUnpledgeBalance;

    @ApiModelProperty("其它业务成本-经销商服务费发生额")
    @TableField(exist = false)
    private BigDecimal otherBusinessCostChannelAmount;

    @ApiModelProperty("其它业务成本-经销商服务费余额")
    @TableField(exist = false)
    private BigDecimal otherBusinessCostChannelBalance;

    @ApiModelProperty("其它业务成本-经销商服务费发生额")
    @TableField(exist = false)
    private BigDecimal payableChannelAmount;

    @ApiModelProperty("其它业务成本-经销商服务费余额")
    @TableField(exist = false)
    private BigDecimal payableChannelBalance;

    @ApiModelProperty("其它业务成本-经销商服务费发生额")
    @TableField(exist = false)
    private BigDecimal payableChannelEstimateAmount;

    @ApiModelProperty("其它业务成本-经销商服务费余额")
    @TableField(exist = false)
    private BigDecimal payableChannelEstimateBalance;
