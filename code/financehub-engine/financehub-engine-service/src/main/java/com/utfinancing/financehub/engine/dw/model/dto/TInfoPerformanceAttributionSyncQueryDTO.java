 ...
 * @Description :   TInfoPerformanceAttributionSync查询from对象
 * @Modified :
 */
@ApiModel("TInfoPerformanceAttributionSync查询表单")
@Data
@EqualsAndHashCode(callSuper = true)
public class TInfoPerformanceAttributionSyncQueryDTO extends BaseQueryDTO{
