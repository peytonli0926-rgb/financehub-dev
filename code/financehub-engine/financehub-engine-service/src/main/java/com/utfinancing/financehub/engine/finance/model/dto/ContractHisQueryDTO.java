 ...
 * @Description :   ContractHis查询from对象
 * @Modified :
 */
@ApiModel("ContractHis查询表单")
@Data
@EqualsAndHashCode(callSuper = true)
public class ContractHisQueryDTO extends BaseQueryDTO{
    ...
    @ApiModelProperty(value = "不包含的处理状态")
    private String notContainProcessStatus;
}
