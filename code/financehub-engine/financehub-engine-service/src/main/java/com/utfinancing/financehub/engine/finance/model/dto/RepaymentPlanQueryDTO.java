 ...
 * @Description :   RepaymentPlan查询from对象
 * @Modified :
 */
@ApiModel("RepaymentPlan查询表单")
@Data
@EqualsAndHashCode(callSuper = true)
public class RepaymentPlanQueryDTO extends BaseQueryDTO{
    ...
    private List<String> recaptureStatusList;
