...
import TransferContractRentPlan from './components/transferContractRentPlan.vue'
...
const permission = computed(() => {
  ...
  return btnPermissions.transferOther
})
...
const state = reactive({
  ...
  tabList: [
    ...
    {
      label: '转让合同租金计划',
      name: 'transferContractRentPlan',
      components: markRaw(TransferContractRentPlan)
    },
    {
      label: '转付',
