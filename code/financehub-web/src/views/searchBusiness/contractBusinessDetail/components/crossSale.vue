  ...
  <div>
    <UTable ref="utableRef" :autoLoad="false" :defaultParams="defaultParams" :options="options"
      ...
      <template #operationBtn="{ row }">
        <el-button type="primary" link size="small" @click="viewVoucher(row)" :disabled="!row.voucherId">查看凭证</el-button>
      </template>
    </UTable>
...
import { crossSaleOptionsConfig } from '../config'
...
const options = crossSaleOptionsConfig(router, dictData)
