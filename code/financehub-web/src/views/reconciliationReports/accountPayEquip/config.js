...
export const optionsConfig = (router, dictData = {}) => ({
  ...
  request: {
    // 请求参数
    list: {
      url: '/engine/finance/check-account-detail-record/yfsbk/resultPage',
      method: 'post'
    }
  },
  btnConfig: {
    export: {
      title: '导出',
      url: '/engine/finance/check-account-detail-record/yfsbk/export',
      filename: '应付设备款对账报表.xlsx',
      isDisabled: false,
      isParams: true
    }
  },
