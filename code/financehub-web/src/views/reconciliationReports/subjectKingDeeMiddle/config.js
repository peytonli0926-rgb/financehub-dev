...
export const optionsConfig = (router, dictData = {}) => ({
  ...
  request: {
    // 请求参数
    list: {
      url: '/engine/finance/check-account-detail-record/resultMiddlePage',
      method: 'post'
    }
  },
  columns: [
    ...
    { prop: 'billContractCode', label: '批次号', width: 200 },
    {
      prop: 'accountCode',
      label: '科目代码',
      search: true,
    ...
    { prop: 'clientName', label: '客户名称', width: 200 },
