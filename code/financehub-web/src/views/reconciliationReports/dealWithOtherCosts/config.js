...
export const optionsConfig = (router, dictData = {}) => ({
  ...
  request: {
    // 请求参数
    list: {
      url: '/engine/finance/check-account-detail-record/yfqtcb/resultPage',
      method: 'post'
    }
  },
  btnConfig: {
    export: {
      title: '导出',
      url: '/engine/finance/check-account-detail-record/yfqtcb/export',
      filename: '应付其他成本对账报表.xlsx',
      isDisabled: false,
      isParams: true
    }
  },
  columns: [
    ...
    {
      prop: 'estimateAccountCode',
      label: '暂估科目编码',
      minWidth: 130
    },
    {
      prop: 'estimateAccountName',
      label: '暂估科目名称',
      minWidth: 130,
      tooltip: true
    },
