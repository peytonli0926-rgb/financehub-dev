<template>
  ...
  <UTable ref="utableRef" :defaultParams="defaultParams" :options="options">
    <template #operateHeaderRight>
      <el-button
        :icon="Switch"
        v-permission="permission.c.dataAsync"
        type="success"
...
import { customerOptionCfg } from '../config'
...
const state = reactive({
  defaultParams: {},
  options: customerOptionCfg(router, dictData),
  periodCodeOption: []
})
...
const permission = computed(() => {
  ...
  return btnPermissions.payableMargin
})
